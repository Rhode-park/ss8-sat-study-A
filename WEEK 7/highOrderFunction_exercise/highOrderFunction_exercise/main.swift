...
rowan.tabShiftKey(skill: rowan.fireBall)
rowan.tabShiftKey(skill: rowan.createWater)
rowan.tabShiftKey(skill: rowan.thunderBolt)
rowan.tabShiftKey(skill: rowan.powerSlash)
rowan.powerSlash()
